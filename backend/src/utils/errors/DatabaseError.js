...
class DatabaseError extends Error {
  ...
  static todoUpdateFailed() {
    return new DatabaseError(
      DATABASE_ERROR_MESSAGES.TODO.UPDATE_FAILED,
  ...
  static todoDeleteFailed() {
    return new DatabaseError(
      DATABASE_ERROR_MESSAGES.TODO.DELETE_FAILED,
      StatusCodes.INTERNAL_SERVER_ERROR
    );
  }
  ...
  static userUpdateFailed() {
    return new DatabaseError(
      DATABASE_ERROR_MESSAGES.USER.UPDATE_FAILED,
      StatusCodes.INTERNAL_SERVER_ERROR
    );
  }
  ...
  static userDeleteFailed() {
    return new DatabaseError(
      DATABASE_ERROR_MESSAGES.USER.DELETE_FAILED,
      StatusCodes.INTERNAL_SERVER_ERROR
    );
  }
  ...
  static teamUpdateFailed() {
    return new DatabaseError(
      DATABASE_ERROR_MESSAGES.TEAM.UPDATE_FAILED,
      StatusCodes.INTERNAL_SERVER_ERROR
    );
  }
  ...
  static teamDeleteFailed() {
    return new DatabaseError(
      DATABASE_ERROR_MESSAGES.TEAM.DELETE_FAILED,
      StatusCodes.INTERNAL_SERVER_ERROR
    );
  }
}
