...
class ServiceError extends Error {
  ...
  static todoNotFound() {
    return new ServiceError(
      SERVICE_ERROR_MESSAGES.TODO.NOT_FOUND,
  ...
  static userNotFound() {
    return new ServiceError(
      SERVICE_ERROR_MESSAGES.USER.NOT_FOUND,
      StatusCodes.NOT_FOUND
    );
  }
  ...
  static usernameAlreadyExists() {
    return new ServiceError(
      SERVICE_ERROR_MESSAGES.USER.USERNAME_ALREADY_EXISTS,
  ...
  static todoNotBelongToUser() {
    return new ServiceError(
      SERVICE_ERROR_MESSAGES.TODO.NOT_BELONG_TO_USER,
  ...
  static teamNotFound() {
    return new ServiceError(
      SERVICE_ERROR_MESSAGES.TEAM.NOT_FOUND,
      StatusCodes.NOT_FOUND
    );
  }
  ...
  static teamNameAlreadyExists() {
    return new ServiceError(
      SERVICE_ERROR_MESSAGES.TEAM.NAME_ALREADY_EXISTS,
      StatusCodes.CONFLICT
    );
  }
  ...
  static teamMemberNotFound() {
    return new ServiceError(
      SERVICE_ERROR_MESSAGES.TEAM.MEMBER_NOT_FOUND,
      StatusCodes.NOT_FOUND
    );
  }
  ...
  static teamLimitExceeded() {
    return new ServiceError(
      SERVICE_ERROR_MESSAGES.TEAM.LIMIT_EXCEEDED,
      StatusCodes.CONFLICT
    );
  }
  ...
  static cannotInviteSelf() {
    return new ServiceError(
      SERVICE_ERROR_MESSAGES.TEAM.CANNOT_INVITE_SELF,
  ...
  static invitationAlreadyExists() {
    return new ServiceError(
      SERVICE_ERROR_MESSAGES.TEAM.INVITATION_ALREADY_EXISTS,
      StatusCodes.CONFLICT
    );
  }
  ...
  static invitationNotFound() {
    return new ServiceError(
      SERVICE_ERROR_MESSAGES.TEAM.INVITATION_NOT_FOUND,
      StatusCodes.NOT_FOUND
    );
  }
  ...
  static teamMemberAlreadyExists() {
    return new ServiceError(
      SERVICE_ERROR_MESSAGES.TEAM.MEMBER_ALREADY_EXISTS,
      StatusCodes.CONFLICT
    );
  }
  ...
  static invalidTeamMemberAction() {
    return new ServiceError(
      SERVICE_ERROR_MESSAGES.TEAM.INVALID_TEAM_MEMBER_ACTION,
      StatusCodes.BAD_REQUEST
    );
  }
  ...
  static teamMemberLimitExceeded() {
    return new ServiceError(
      SERVICE_ERROR_MESSAGES.TEAM.MEMBER_LIMIT_EXCEEDED,
      StatusCodes.CONFLICT
    );
  }
  ...
  static invalidTeamRole() {
    return new ServiceError(
      SERVICE_ERROR_MESSAGES.TEAM.INVALID_TEAM_ROLE,
      StatusCodes.BAD_REQUEST
    );
  }
  ...
  static teamHasMembers() {
    return new ServiceError(
      SERVICE_ERROR_MESSAGES.TEAM.HAS_MEMBERS,
      StatusCodes.CONFLICT
    );
  }
}
